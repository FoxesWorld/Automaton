...
public class ComponentManager {
    ...
    public IdentifiableLabel addLabel(String text, String elementIdText, Container parent) {
    ...
    public IdentifiableProgressBar addProgressBar(String id, float initialValue, Container parent) {
